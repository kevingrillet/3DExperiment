 ...
 *  - `t(key)`  : la fonction de traduction (clé pointée, ex. `viewer.tab3d`).
 *                Une clé absente est renvoyée telle quelle (aide au repérage).
 *
 * Le contexte a une valeur par défaut en français : les composants fonctionnent
 * même hors `<I18nProvider>` (utile en tests / Storybook isolés).
 */

 ...
 *
 * Il affiche le drapeau de la langue active et bascule vers l'autre au clic. Les
 * drapeaux sont des SVG inline (et non des emojis) : ils s'affichent de façon
 * identique sur toutes les plateformes — notamment Windows, où les emojis drapeaux
 * ne sont pas rendus — et leur taille fixe évite tout décalage de mise en page.
 */
...
export function LanguageSwitcher() {
  ...
  return (
    <button
      ...
      className="inline-flex h-10 w-10 items-center justify-center rounded-lg border border-line bg-surface transition hover:bg-subtle"
    >
      <Flag />
    </button>
  );
